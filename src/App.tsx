        ...
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          <div className="flex items-center gap-3">
            <div className="logo-shine logo-reflection logo-float bg-white rounded-full p-1 shadow-sm border border-acai/5">
              <img 
                src="https://res.cloudinary.com/dnkggulhp/image/upload/v1780766413/WhatsApp_Image_2026-05-17_at_9.59.27_PM_zgdbmb.jpg" 
...
const Hero = () => {
  ...
  const mediaItems = [
    { type: 'video', url: "https://res.cloudinary.com/dnkggulhp/video/upload/v1780767931/untitled_Grok_Imagine_Video_2026-06-06_17-41-13_xcsek0.mp4" },
    { type: 'image', url: "https://res.cloudinary.com/dnkggulhp/image/upload/v1780766411/WhatsApp_Image_2026-05-13_at_10.12.19_PM_2_o6sus3.jpg" }
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl text-acai mb-6 font-black leading-[0.9]">
            O Açaí mais <br />
            <span className="text-indigo italic drop-shadow-sm">desejado</span> <br />
            de Alagoas.
          </h1>
          <p className="text-lg md:text-xl text-acai/70 mb-10 max-w-lg mx-auto lg:mx-0 font-medium leading-tight">
            Natural, cremoso e simplesmente inesquecível. O verdadeiro açaí premium com frutas frescas, pistache crocante e ingredientes selecionados, sem conservantes.
          </p>
...
const MenuSection = () => {
  const categories = [
    { 
      ...
      name: '🍇 Açaí & Montagem', 
      icon: <Soup size={18} />,
      image: "https://res.cloudinary.com/dnkggulhp/image/upload/v1780766408/WhatsApp_Image_2026-04-30_at_6.03.03_PM_ofatjs.jpg",
      items: [
    ...
    { 
      ...
      image: "https://res.cloudinary.com/dnkggulhp/image/upload/v1780766405/WhatsApp_Image_2026-04-26_at_6.53.34_PM_1_wj26ik.jpg",
      items: [
    ...
    { 
      ...
      image: "https://res.cloudinary.com/dnkggulhp/image/upload/v1780766406/WhatsApp_Image_2026-04-26_at_6.53.34_PM_ujd7gi.jpg",
      items: [
...
const Gallery = () => {
  const media = [
    ...
    { type: 'video', src: "https://res.cloudinary.com/dnkggulhp/video/upload/v1780767931/untitled_Grok_Imagine_Video_2026-06-06_17-41-13_xcsek0.mp4" },
    { type: 'video', src: "https://res.cloudinary.com/dnkggulhp/video/upload/v1780767938/WhatsApp_Video_2026-06-06_at_2.44.24_PM_cczmcs.mp4" },
    { type: 'image', src: "https://res.cloudinary.com/dnkggulhp/image/upload/v1780766407/WhatsApp_Image_2026-04-26_at_8.23.09_PM_4_nfu1ea.jpg" },
    { type: 'video', src: "https://res.cloudinary.com/dnkggulhp/video/upload/v1780767933/WhatsApp_Video_2026-06-06_at_12.18.08_AM_yv3rwi.mp4" },
    { type: 'image', src: "https://res.cloudinary.com/dnkggulhp/image/upload/v1780766407/WhatsApp_Image_2026-04-26_at_8.23.09_PM_cxbmvv.jpg" },
    { type: 'video', src: "https://res.cloudinary.com/dnkggulhp/video/upload/v1780767920/untitled_Grok_Imagine_Video_2026-06-06_02-13-04_rh1z9g.mp4" },
    { type: 'video', src: "https://res.cloudinary.com/dnkggulhp/video/upload/v1780766412/video_Grok_00015__rsbmmk.mp4" },
    { type: 'image', src: "https://res.cloudinary.com/dnkggulhp/image/upload/v1780766406/WhatsApp_Image_2026-04-26_at_8.23.09_PM_2_ehr4i4.jpg" },
  ...
  const units = [
    {
      ...
      image: "https://res.cloudinary.com/dnkggulhp/image/upload/v1780766413/WhatsApp_Image_2026-05-17_at_4.26.42_PM_bedy5w.jpg",
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/dnkggulhp/image/upload/v1780766413/WhatsApp_Image_2026-05-17_at_8.17.54_PM_diybph.jpg",
